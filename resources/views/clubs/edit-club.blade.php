        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('club/list/page') }}">Clubs</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('club.update', $club->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Edit Club Details</span></h5>
                                </div>

                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Club ID <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="club_id"
                                            value="{{ old('club_id', $club->club_id) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control" name="club_leader"
                                            value="{{ old('club_leader', $club->club_leader) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms calendar-icon">
                                        ...
                                        <input type="date" class="form-control" name="founded_date"
                                            value="{{ old('founded_date', $club->founded_date) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="number" class="form-control" name="member_count"
                                            value="{{ old('member_count', $club->member_count) }}" required>
                                    </div>
                                </div>
